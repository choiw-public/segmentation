...
class ModelFunction(Model):
    def __init__(self, config):
        ...
        self.root = conv_blocks.Conv(16, 5, 1, l2_decay, True, False, 0, 'root')

        self.encoder1a = conv_blocks.DenseConcat([16, 16], [5, 3], l2_decay, 0, 'encoder1a')  # 4
        self.encoder1a_skip = conv_blocks.Conv(32, 1, 1, l2_decay, True, True, 0, 'encoder1a_skip')
        self.encoder1b = conv_blocks.Conv(32, 3, 2, l2_decay, True, True, 0, 'encoder1b')

        self.encoder2a = conv_blocks.DenseConcat([8, 16, 16], [7, 5, 3], l2_decay, 4, 'encoder2a')  # 4
        self.encoder2a_skip = conv_blocks.Conv(64, 1, 1, l2_decay, True, True, 0, 'encoder2a_skip')
        self.encoder2b = conv_blocks.Conv(64, 3, 2, l2_decay, True, True, 0, 'encoder2b')

        self.encoder3a = conv_blocks.DenseConcat([16, 16, 16, 32], [9, 7, 5, 3], l2_decay, 4, 'encoder3a')  # 4
        self.encoder3a_skip = conv_blocks.Conv(128, 1, 1, l2_decay, True, True, 0, 'encoder3a_skip')
        self.encoder3b = conv_blocks.Conv(128, 3, 2, l2_decay, True, True, 0, 'encoder3b')

        self.encoder4a = conv_blocks.DenseConcat([32, 40, 56, 64, 80], [11, 9, 7, 5, 3], l2_decay, 4, 'encoder4a')  # 4
        self.encoder4b = conv_blocks.Conv(400, 3, 1, l2_decay, True, True, 0, 'encoder4b')

        self.decoder1 = conv_blocks.Conv(128, 3, 1, l2_decay, True, True, 0, 'decoder1')  # 4
        self.decoder2 = conv_blocks.Conv(64, 3, 1, l2_decay, True, True, 0, 'decoder2')  # 4
        self.decoder3 = conv_blocks.Conv(32, 3, 1, l2_decay, True, True, 0, 'decoder3')  # 4
